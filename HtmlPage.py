...
"""
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
     ...
     <div class="list-group list-group-flush">
      <a href="/" class="list-group-item list-group-item-action bg-light">Host-Configs</a>
      <a href="/ovs" class="list-group-item list-group-item-action bg-light">OpenVSwitch</a>
      <a href="/invertory" target="_blank" class="list-group-item list-group-item-action bg-light">Ansible-Invertory</a>
      <a href="/checkmk" target="_blank" class="list-group-item list-group-item-action bg-light">CheckMK-CSV</a>
     </div>
""" + embed + """
    </div>
